...
(function(t, x)
{
  ...
  f.fn = f.prototype = {init:function(a, b)
  {
    ...
    {
      b = b.ownerDocument || b;
      if (c = va.exec(a))a = [b.createElement(c[1])];
      else
      {
        c = $([a], [b]);
    ...
    else if (ta.test(a) && b.nodeType === 9)
    {
      a = a.slice(1);
  ...
  {
    for (var c = 0,d = this.length; c < d; c++)f.event.add(this[c], a, b);
    return this
  },unbind:function(a, b)
  {
    for (var c = 0,d = this.length; c < d; c++)f.event.remove(this[c], a, b);
    return this
  },hover:function(a, b)
  {
  ...
  {
    if (a === x)return this[0] ? this[0].innerHTML : null;
    else if (typeof a === "string" && !xa.test(a))for (var b = 0,c = this.length; b < c; b++)
    {
  ...
  {
    if (a === x)return this[0] ? this[0].innerText ? this[0].innerText : this[0].textContent : null;
  ...
  },val:function(a)
  {
    if (a === x)
    {
      ...
      if (b)
      {
        if (F(b, "option"))return(b.attributes.value || {}).specified ? b.value : b.text;
        if (F(b, "select"))
        {
          a = b.selectedIndex;
  ...
  },addClass:function(a)
  {
    ...
    {
      d = this[b];
      if (d.className)for (var h = " " + d.className + " ",i = 0,m = g.length; i < m; i++)
      {
  ...
  },removeClass:function(a)
  {
    for (var b = 0,c = this.length,d,g = (a || "").split(ba); b < c; b++)
    {
      ...
      if (a)
      {
        for (var h = (" " + d.className + " ").replace(ya, " "),i = 0,m = g.length; i < m; i++)h = h.replace(" " + g[i] + " ", " ");
  ...
  },empty:function()
  {
    ...
    {
      c = this[a];
      for (c.nodeType === 1 && P(c.getElementsByTagName("*")); c.firstChild;)c.removeChild(c.firstChild)
    }
    return this
  },map:function(a)
  {
  ...
  },is:function(a)
  {
    ...
    for (var b = 0,c = this.length; b < c; b++)if (U(this[b], a) >= 0)return true;
    return false
  },append:function()
  {
  ...
  },insert:function(a, b, c)
  {
    ...
    if (this[0])
    {
      ...
      {
        b = b && F(g, "tr");
        for (var m = 0,z = this.length; m < z; m++)c.call(b ? d(this[m], g) : this[m], this.length > 1 || a.cacheable || m > 0 ? i.cloneNode(true) : i)
      }
  ...
  {
    if (!a || R.call(a) !== "[object Object]" || a.nodeType || a.setInterval)return false;
  ...
  f.extend = f.fn.extend = function()
  {
    ...
    {
      c = b[d];
      if (a !== c)a[d] = f.isPlainObject(c) && !M(c) ? arguments.callee(a[d] || {}, c) : c
    }
    return a
  };
  ...
  },globalEval:function(a)
  {
    if (a && /\S/.test(a))
    {
      ...
      if (G.ie)c.text = a;
      else c.appendChild(k.createTextNode(a));
  ...
  },isReady:false,ready:function()
  {
    if (!f.isReady)
    {
      if (!k.body)return setTimeout(f.ready, 13);
      f.isReady = true;
      if (L)
      {
        for (var a,b = 0; a = L[b++];)a.call(k, f);
        L = null
      }
    }
  },bindReady:function()
  {
    ...
    {
      Z = true;
      if (k.readyState === "complete")return f.ready();
  ...
  f.extend({toArray:function(a)
  {
    ...
    {
      var c = a.length;
      if (c == null || typeof a === "string" || T(a) || a.setInterval)b[0] = a;
      else for (; c;)b[--c] = a[c]
    }
    return b
  ...
  if (k.addEventListener)J = function()
  {
    k.removeEventListener("DOMContentLoaded", J, false);
    f.ready()
  };
  else if (k.attachEvent)J = function()
  {
  ...
  }},event:{add:function(a, b, c)
  {
    ...
    {
      f.cache[d].events[b] = {};
      if (a.addEventListener)a.addEventListener(b, f.cache[d].listener, false);
      else a.attachEvent && a.attachEvent("on" + b, f.cache[d].listener)
    }
    if (c)
    {
      if (!c.fuid)c.fuid = f.cache.fuid++;
  ...
  },remove:function(a, b, c)
  {
    ...
    {
      d = h.events;
      if (b === x)for (b in d)f.event.remove(a, b);
      else
      {
        if (d[b])
        {
          if (c)delete d[b][c.fuid];
          else for (var i in d[b])delete d[b][i];
          for (g in d[b])break;
          if (!g)
          {
            da(a, b, h.listener);
  ...
  {
    if (!a.preventDefault)a.preventDefault = Ba;
    if (!a.stopPropagation)a.stopPropagation = Ca;
  ...
  {
    for (var b,c,d = f.cache,g = 0,h; (h = a[g]) != null; g++)if (b = h.lhguid)
    {
      c = d[b];
      if (c.events)for (var i in c.events)da(h, i, c.listener);
      W(h, ["lhguid"]);
      delete d[b]
    }
  };
  ...
  (function()
  {
    ...
    },"nth-child":function(e, j)
    {
      ...
      {
        var n = 0,s = e;
        for (s = q.firstChild; s; s = s.nextSibling)if (s.nodeType === 1)s.nodeIndex = ++n
      }
      e = e.nodeIndex - j;
    ...
    f.find = function(e, j)
    {
      ...
      if (c.test(e) && j.nodeType)
      {
        var q = 0;
        switch (e.charAt(0))
            {case".":var n = e.slice(1);if (a)l = j.getElementsByClassName(n);
        else
        {
          n = " " + n + " ";
          for (var s = j.getElementsByTagName("*"),H = 0; j = s[H++];)if ((" " + j.className + " ").indexOf(n) !== -1)l[q++] = j;
          l = q ? l : []
        }break;case":":s = j.getElementsByTagName("*");H = 0;for (e = e.slice(1); j = s[H++];)if (u[e] && u[e](j))l[q++] = j;l = q ? l : [];break;default:l = j.getElementsByTagName(e);break}
      }
      else
      {
        if (b)try
        ...
        for (var ea = e.split(d),fa = ea.length - 1,Da = !!fa,ga,ha,o,X,A,B,C,v,w,N,D,ia,r,O,Q,I; q = ea[fa--];)
        {
          ...
          H = 0;
          X = " ";
          for (s = j.nodeType ? [j] : K(j); o = ga[H++];)if (o !== " " && o !== ">" && o !== "~" && o !== "+" && s)
          {
            o = o.match(g);
            A = o[1] || "*";
            B = o[2];
            ...
            D = [];
            q = ia = 0;
            for (O = H == ha; r = s[ia++];)switch (X)
                {case" ":Q = r.getElementsByTagName(A);for (I = 0; n = Q[I++];)if ((!B || n.id === B) && (!C || (" " + n.className + " ").indexOf(C) !== -1) && (!v || p[w] && (p[w](n, v, o[6]) || v === "class" && p[w](n, "className", o[6]))) && !n.yeasss && (u[e] ? u[e](n, N) : !e))
            {
              if (O)n.yeasss = 1;
              D[q++] = n
            }break;case"~":for (A = A.toLowerCase(); (r = r.nextSibling) && !r.yeasss;)if (r.nodeType === 1 && (A === "*" || r.nodeName.toLowerCase() === A) && (!B || r.id === B) && (!C || (" " + r.className + " ").indexOf(C) !== -1) && (!v || p[w] && (p[w](n, v, o[6]) || v === "class" && p[w](n, "className", o[6]))) && !r.yeasss && (u[e] ? u[e](r, N) : !e))
            {
              if (O)r.yeasss = 1;
              D[q++] = r
            }break;case"+":for (; (r = r.nextSibling) && r.nodeType !== 1;);if (r && (r.nodeName.toLowerCase() === A.toLowerCase() || A === "*") && (!B || r.id === B) && (!C || (" " + n.className + " ").indexOf(C) !== -1) && (!v || p[w] && (p[w](n, v, o[6]) || v === "class" && p[w](n, "className", o[6]))) && !r.yeasss && (u[e] ? u[e](r, N) : !e))
            {
              if (O)r.yeasss = 1;
              D[q++] = r
            }break;case">":Q = r.getElementsByTagName(A);for (I = 0; n = Q[I++];)if (n.parentNode === r && (!B || n.id === B) && (!C || (" " + n.className + " ").indexOf(C) !== -1) && (!v || p[w] && (p[w](n, v, o[6]) || v === "class" && p[w](n, "className", o[6]))) && !n.yeasss && (u[e] ? u[e](n, N) : !e))
            {
              if (O)n.yeasss = 1;
              D[q++] = n
            }break}
        ...
        for (q = l.length; q--;)W(l[q], ["yeasss","nodeIndex"])
      }
      return l
    }
  })();
  ...
  },aa = function(a, b, c, d)
  {
    ...
    for (; h < i; h++)for (b in g)f[d](a[h], b, g[b]);
    return a
  };
  f.extend({attr:function(a, b, c)
  {
    b = na[b] || b;
    if (ka.test(b))if (b == "style" && G.ie)a.style.cssText = c;
  ...
  },getAttr:function(a, b)
  {
    ...
    {
      if (F(a, "form") && a.getAttributeNode(b))return a.getAttributeNode(b).nodeValue;
      return a[b]
    }
  },css:function(a, b, c)
  {
    a = a.style;
    b = Fa[b] || b;
    if (G.ie && b == "opacity")a.filter = (a.filter || "").replace(/alpha\([^)]*\)/, "") + (parseInt(c) + "" == "NaN" ? "" : "alpha(opacity=" + c * 100 + ")");
    else
    {
      b = b.replace(ma, oa);
      a[b] = c
  ...
  {
    var c,d = a.style;
    if (b == "opacity")return G.ie ? d.filter && d.filter.indexOf("opacity=") >= 0 ? parseFloat(d.filter.match(/opacity=([^)]*)/)[1]) / 100 : 1 : d.opacity ? parseFloat(d.opacity) : 1;
    if (la.test(b))b = f.props["float"];
    if (d && d[b])c = d[b];
    else if (ja.getComputedStyle)
    {
      if (la.test(b))b = "float";
      b = b.replace(Ea, "-$1").toLowerCase();
      if (a = ja.getComputedStyle(a, null))c = a.getPropertyValue(b)
    }
  ...
  E.th = E.td;
  if (G.ie)E.link = E.script = [1,"div<div>","</div>"];
  var La = function(a, b, c, d)
  {
    b = b || k;
    if (typeof b.createElement === "undefined")b = b.ownerDocument || b[0] && b[0].ownerDocument || k;
    for (var g = [],h = 0,i = a.length,m; h < i; h++)
    {
      m = a[h];
      if (!m)return;
      if (typeof m === "string" && !Ha.test(m))m = b.createTextNode(m);
      else if (typeof m === "string")
      {
        ...
        for (p.innerHTML = z[1] + m + z[2]; y--;)p = p.lastChild;
        G.ie && /^\s+/.test(m) && p.insertBefore(b.createTextNode(/^\s+/.exec(m)[0]), p.firstChild);
        m = K(p.childNodes)
      }
      if (m.nodeType)g.push(m);
      else g = g.concat(m)
    }
    if (c)for (h = 0; g[h]; h++)if (d && F(g[h], "script") && (!g[h].type || g[h].type.toLowerCase() === "text/javascript"))d.push(g[h].parentNode ? g[h].parentNode.removeChild(g[h]) : g[h]);
    else
    {
  ...
  },$ = function(a, b, c)
  {
    ...
    {
      g = true;
      if (h = f.fragments[a[0]])if (h !== 1)d = h
    }
    if (!d)
    {
  ...
  }}, function(a, b)
  {
    f.fn[a] = function(c)
    {
      ...
      {
        for (var h = 0,i = d.length; h < i; h++)f(d[h]).is(c) && g.push(d[h]);
        d = g
      }
  ...
  },accepts:{xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",text:"text/plain",rdefault:"*/*"}},ajax:function(a)
  {
    ...
    if (a.data && typeof a.data !== "string")a.data = f.param(a.data);
    ...
    var l = function(s)
    {
      ...
      else if (!u && e && (e.readyState == 4 || s == "timeout"))
      {
        u = true;
        if (q)
        {
  ...
  },httpData:function(a, b)
  {
    ...
    if (c && a.documentElement.tagName == "parsererror")throw"parsererror";
    if (typeof a === "string")
    {
      b == "script" && f.globalEval(a);
      if (b == "json")a = t.eval("(" + a + ")")
    }
    return a
  },param:function(a)
  {
    ...
    var c = [];
    if (M(a) || a.lhgren)for (var d = 0,g = a.length; d < g; d++)b(this[d].name, this[d].value);
    else for (var h in a)if (M(a[h]))
    {
      d = 0;
      for (g = a[h].length; d < g; d++)b(h, a[h][d])
    }
    else b(h, T(a[h]) ? a[h]() : a[h]);
